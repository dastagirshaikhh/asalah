              ...
              >
                ...
                <CardContent className="relative p-6 rounded-lg h-full flex flex-col">
                  <div className="text-center mb-6">
                    ...
                    <div className="text-3xl font-bold text-gray-800">{pkg.price}</div>
                    {"sessions" in pkg && (
                      <div className="text-sm text-gray-500 mt-1">{(pkg as { sessions: string }).sessions}</div>
                    )}
                    {"platforms" in pkg && (
                      <div className="text-sm text-gray-500 mt-1">{(pkg as { platforms: string }).platforms}</div>
                    )}
                  </div>
